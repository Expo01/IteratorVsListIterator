...
//        System.out.println(placesToVisit);
    ...
    private static void testIterator(LinkedList<String>list){
        ...
        var iterator = list.listIterator(); // not .Iterator so we can add
        while(iterator.hasNext()){
//            System.out.println(iterator.next());
            if (iterator.next().equals("Brisbane")){
//                iterator.remove();
                iterator.add("Lake Wivenhoe"); // .add only possible with listIterator,
            }
        }
        ...
        var iterator2 = list.listIterator(3); //cursor set to begin hovering between index 2 and 3
